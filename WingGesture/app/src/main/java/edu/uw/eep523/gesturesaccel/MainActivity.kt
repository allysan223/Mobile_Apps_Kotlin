...
class MainActivity : AppCompatActivity() , SensorEventListener {
    ...
    override fun onSensorChanged(event: SensorEvent) {
        ...
        capturedData.set(nsamples+1, linear_acceleration[1]) // repeat for x, y, z
        capturedData.set(nsamples+2, linear_acceleration[2]) // repeat for x, y, z
    ...
    fun make_prediction(view: View){
        ...
        mSensorManager.registerListener(this, mSensor, 40000) //25 Hz
